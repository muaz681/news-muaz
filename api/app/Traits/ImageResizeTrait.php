...
trait ImageResizeTrait{
    ...
    private function upload($file , $imageable_id , $existing_id, $request)
    {
        ...
        $save = $this->resizeImage($file, $fileNameToStore , $imageable_id , $existing_id, $request);

        // return $save;
    }

    public function resizeImage($file, $fileNameToStore , $imageable_id ,  $existing_id, $request)
    { 
        $date = date('Y-m');
        ...
        $attributes = [
            ...
            // 'img_author' => $img_data->img_author,
            'file_name' => null,
            'featured' => false,
            'mime_type' => null,
            'is_active' => 'Yes',
            'img_title' => $request->img_title,
            'img_author' => $request->img_author
        ];
