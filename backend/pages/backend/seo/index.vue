            ...
            <v-card>
              ...
              >
                ...
                <template v-slot:item.seos="{ item }">
                  <nuxt-link :to="{ name: getRouterLink(item.seoable_type), params: { id: item.seoable_id }}">
                    <v-icon
                      small
                      class="mr-2"
                    >
                  ...
                  <nuxt-link :to="{ name: 'backend-seo-update-id', params: { id: item.id }}">
                    <v-icon
                      small
                      class="mr-2"
                    >
                ...
                <template v-slot:item.meta_description="{ item }">
                  ...
                  <div class="truncate" v-if="item.meta_description == 'null'"></div>
                  <div class="truncate" v-else>{{item.meta_description}}</div>
