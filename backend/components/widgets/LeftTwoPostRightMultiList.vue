<template>
  <div>
    ...
    <!-- Content Section -->
    <div v-if="this.postsLoaded !== null" class="grid grid-cols-12 gap-2 py-4">
      <!-- Left side -->
      ...
      <div class="lg:col-span-6 col-span-12">
        ...
        <div class="grid grid-cols-12 p-2 divide-y divide-zinc-300">
          <div v-for="(post, i) in postsLoaded" :key="i"
    ...
    <div v-else class="grid grid-cols-12 gap-2 py-4">
      <div class="lg:col-span-6 col-span-12">
        <div class="grid grid-cols-12 gap-2">
          <div v-for="(n,i) in 1"
               :key="n" class="col-span-12">
