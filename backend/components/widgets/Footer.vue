    ...
    <div>
        ...
        <div class="mx-6 py-10 text-center md:text-left">
            ...
            <div class="">
                ...
                <p class="mb-4">
                <a href="#!" class="text-gray-600">আমাদের সম্পর্কে</a>
                </p>
                <p class="mb-4">
                <a href="#!" class="text-gray-600">প্রাইভেসি পলিসি</a>
                </p>
                <p class="mb-4">
                <a href="#!" class="text-gray-600">কুকি পলিসি</a>
                </p>
            </div>
        ...
        <div class="text-center p-6 bg-gray-200">
            ...
            <a class="text-gray-600 font-semibold" href="https://cinebaz.com/">Cinebaz Limited</a>
        </div>
    </div>
</template>
<script>
