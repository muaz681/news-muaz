    ...
    <div class="grid grid-cols-12 gap-2 py-4">
      <div v-if="this.postsLoaded !== null" class="lg:col-span-8 col-span-12">
        <div class="grid grid-cols-2 gap-1">
          <div v-for="(post, i) in postsLoaded" :key="i" v-if="i >= 0 && i <= 3" class="lg:col-span-1 col-span-2">
      ...
      <div v-else class="lg:col-span-8 col-span-12">
        <div class="grid grid-cols-2 gap-1">
          <div v-for="(n,i) in 4"
               :key="n" class="lg:col-span-1 col-span-2">
      ...
      <div v-if="this.postsLoaded !== null" class="lg:col-span-4 col-span-12">
        ...
        >
            <div v-for="(post, i) in postsLoaded" :key="i" v-if="i >= 4 && i <= 13" class="col-span-12 py-2">
...
export default {
  name: "OverlayImageWithListColumns",
  props: [
