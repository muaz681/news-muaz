  ...
  <div>
    ...
    <div v-if="title" class="grid grid-cols-9 gap-4 my-4 py-2 px-2 border-y-2 border-zinc-600">
      ...
      <div class="col-start-3 col-end-9 lg:block hidden">
        <ul
          class="menu-scroll overflow-auto whitespace-nowrap flex-wrap -mb-px text-sm font-medium text-center leading-8 justify-center"
          id="myTab"
          data-tabs-toggle="#myTabContent"
          role="tablist"
        >
          <li class="mr-2 inline-block" role="presentation">
            <button
          ...
          <li v-if="Object.values(tag_ids).find(element => element == tag.id)" v-for="(tag, i) in tag_names" :key="i" class="mr-2 inline-block" role="presentation">
            <button
              class="inline-block px-2 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 font-sans text-sm"
    ...
    <div v-bind:class="{ hidden: openTab !== 1, block: openTab === 1 }">
      <div class="grid grid-cols-12 gap-2">
        <div
          v-for="(post, i) in postsLoaded" :key="i"
          v-if="i >= 2 && i <= 11"
          class="lg:col-span-6 col-span-12 py-2 border-b-2 border-zinc-300"
        >
